...
#define DD_SYSTEM_REGISTRY_VISIBILITY MY_ATTRIBUTE((visibility("hidden")))
#else
#define DD_SYSTEM_REGISTRY_VISIBILITY
#endif
...
class DD_SYSTEM_REGISTRY_VISIBILITY System_tables {
 public:
  /*
...
class DD_SYSTEM_REGISTRY_VISIBILITY System_views {
 public:
  /*
...
class DD_SYSTEM_REGISTRY_VISIBILITY System_tablespaces {
 public:
