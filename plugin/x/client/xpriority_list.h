...
#define XCL_PRIORITY_LIST_VISIBILITY MY_ATTRIBUTE((visibility("default")))
#else
#define XCL_PRIORITY_LIST_VISIBILITY
#endif

template <typename Element_type,
          bool (*Priority_compare)(const Element_type &, const Element_type &) =
              Element_type::compare>
class XCL_PRIORITY_LIST_VISIBILITY Priority_list {
 public:
